...
<div>
    ...
    <div style="margin-top: 70px;margin-bottom: 10px;margin-right: 3px;margin-left: 10px;min-height: 400px;">
       ...
       @if($errors->any())
        ...
        <div class="form-row">
            ...
            <div class="col-sm-4 col-sm-3" style="max-width: 200px;">
                <div class="form-group"><button class="btn btn-primary" type="submit" value="accept" style="background-color: rgb(7,55,108);margin: 0px;margin-right: 10px;margin-left: 10px;">Modify</button><span style="padding: 4px;padding-left: 10px;"><a class="btn btn-primary" role="button" href="{{route('admin.deleteMainPost',[$postDescription->id])}}" style="height: 38px;padding-top: 6px;background-color: rgb(7,55,108);">Delete</a></span></div>
            </div>
