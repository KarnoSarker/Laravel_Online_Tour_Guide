...
<span class="dropdown float-right" style="margin-top: 0px;margin-right: 43.5px; margin-bottom: 5px "><button class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button" style="background-color: rgb(40,45,50);">Category &nbsp;</button>
                        
                         <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="{{route('index.viewPostCategoryWise',['Natural'])}}">Natural</a><a class="dropdown-item" role="presentation" href="{{route('index.viewPostCategoryWise',['Historical'])}}">Historical</a><a class="dropdown-item" role="presentation" href="{{route('index.viewPostCategoryWise',['Artificial'])}}">Artificial</a></div>
    ...
    @endif
        ...
        <div>
            ...
            <span class="dropdown float-right" style="margin-top: 0px;margin-right: 40px;"><button class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button" style="background-color: rgb(40,45,50);">District &nbsp;</button>
                        
                         <div class="dropdown-menu" role="menu">
                         @foreach($district as $district1)
                            <a class="dropdown-item" role="presentation" href="{{route('index.viewPostDistrictWise',[$district1->division,$district1->district])}}">{{$district1->district}}</a>  
                        @endforeach
                    ...
                    <div class="col-md-12">
                        <div id="insert_here">
                           ...
                           <figure class="snip1527">
                              <div class="image"><img src="{{asset($post->image) }}" alt="post_image" /></div>
                              <figcaption>
                                <div class="location"><span class="district"> {{$post->district}} </span><span class="division"> {{$post->division}} </span></div>

                                @if($post->title_count >30 ) <h3> {{$post->name_bangla}}... </h3>
                                @else <h3> {{$post->name_bangla}} </h3> @endif
                                
                                
                                  @if( $post->description_count >110 )  <p> {{$post->description}} . . . </p> 
                                @else <p> {{$post->description}} </p> @endif
                                
                              </figcaption>
                              <a href="{{route('post.index',[$post->id])}}"> </a>
                            </figure>
       ...
       <div class="footer-basic cls_footer" style="height: 105px;color: rgb(40,45,50);">
        <footer>
